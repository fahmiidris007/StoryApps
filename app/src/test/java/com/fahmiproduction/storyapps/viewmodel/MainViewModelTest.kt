...
import com.fahmiproduction.storyapps.DataDummy
import com.fahmiproduction.storyapps.MainDispatcherRule
...
import com.fahmiproduction.storyapps.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val actualStory: PagingData<Story> = mainViewModel.getStory(token).getOrAwaitValue()
